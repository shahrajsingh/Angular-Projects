...
export class TaskService {
  ...
  getimptask() {
    const UserId = this.authService.getUserId();
    this.http.get<{ message: String; result: Task[];}>(BACKEND_URL+"/imptask/"+UserId).subscribe((res: any) => {
  ...
  getmyDaytask() {
    const UserId = this.authService.getUserId();
    this.http.get<{ message: String; result: Task[];}>(BACKEND_URL+"/mydaytask/"+UserId).subscribe((res: any) => {
  ...
  completeTask(id: String) {
    ...
    this.http.put<{ message: String }>(BACKEND_URL+ UserId, body).subscribe((res: any) => {
      console.log(res.message);
    });
